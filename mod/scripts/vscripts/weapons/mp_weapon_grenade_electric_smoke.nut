...
void function ElectricGrenadeSmokescreen( entity projectile, asset fx )
{
	...
	// modified fix here: inflictor should be projectile itself
	// so we can get correct entity upon damage
	// this shouldn't break compatiblility with other mods... cuz there're no mods modified this script?
	...
	// so we don't get invalid inflictor case
