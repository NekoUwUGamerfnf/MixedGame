...
// modified!!
global function AddShifterModifier
...
// modified!!!
void function AddShifterModifier( string modName )
{
	if ( !( file.shifterModifiers.contains( modName ) ) )
		file.shifterModifiers.append( modName )
}

bool function HasShifterModifier( array<string> mods )
{
