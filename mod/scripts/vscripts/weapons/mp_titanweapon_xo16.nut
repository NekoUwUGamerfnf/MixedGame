...
var function OnWeaponPrimaryAttack_titanweapon_xo16( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	...
	// modified here: we don't want to use any other behavior, just to stop accelerator looping sound
	...
	if ( weapon.HasMod( "accelerator" ) )
	{
		// try not to signal too many stuffs
		//StopSoundOnEntity( weapon, "Weapon_xo16_fire_first_1P" )
		//StopSoundOnEntity( weapon, "Weapon_xo16_fire_first_3P" )
		StopSoundOnEntity( weapon, "Weapon_xo16_fire_loop_1P" )
		StopSoundOnEntity( weapon, "Weapon_xo16_fire_loop_3P" )
	}
