...
global function MpTitanWeaponArchonArcCannon_Init

global function OnWeaponActivate_titanweapon_archon_arc_cannon
global function OnWeaponDeactivate_titanweapon_archon_arc_cannon
global function OnWeaponOwnerChanged_titanweapon_archon_arc_cannon
global function OnWeaponChargeBegin_titanweapon_archon_arc_cannon
global function OnWeaponChargeEnd_titanweapon_archon_arc_cannon
global function OnWeaponPrimaryAttack_titanweapon_archon_arc_cannon

#if SERVER
global function OnWeaponNpcPrimaryAttack_titanweapon_archon_arc_cannon
#endif // #if SERVER
...
void function OnWeaponActivate_titanweapon_archon_arc_cannon( entity weapon )
{
...
void function OnWeaponDeactivate_titanweapon_archon_arc_cannon( entity weapon )
{
...
void function OnWeaponOwnerChanged_titanweapon_archon_arc_cannon( entity weapon, WeaponOwnerChangedParams changeParams )
{
	#if CLIENT
...
bool function OnWeaponChargeBegin_titanweapon_archon_arc_cannon( entity weapon )
{
...
void function OnWeaponChargeEnd_titanweapon_archon_arc_cannon( entity weapon )
{
	weapon.StopWeaponSound("MegaTurret_Laser_ChargeUp_3P")
...
#if SERVER
var function OnWeaponNpcPrimaryAttack_titanweapon_archon_arc_cannon( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	// modified here: use weaponSettings var
	//local fireRate = weapon.GetWeaponInfoFileKeyField( "fire_rate" )
	float fireRate = weapon.GetWeaponSettingFloat( eWeaponVar.fire_rate )
	...
	if ( vortexHit )
	{
		expect VortexBulletHit( vortexHit )
			...
			else if ( IsVortexSphere( vortexHit.vortex ) )
			{
				...
				int damage = int( damageNear * GraphCapped( chargeFrac, 0, 1, 0.0, 10.0 ) ) // do more damage the more charged the weapon is.
...
function FireArcWithTargets( entity weapon, table firstTargetInfo, WeaponPrimaryAttackParams attackParams, muzzleOrigin )
{
	...
	if ( weapon.HasMod( "archon_arc_cannon" ) )
		zapInfo.dmgSourceID = eDamageSourceId.mp_titanweapon_archon_arc_cannon
